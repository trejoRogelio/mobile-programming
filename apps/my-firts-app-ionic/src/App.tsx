            ...
            <IonTabs>
                <IonRouterOutlet>
                    ...
                    <Route exact path="/tab2">
                        <Tab2 deletePhoto={deletePhoto} photos={photos} takePhoto={takePhoto}/>
                    </Route>
                    <Route path="/tab3">
                        <Tab3 deletePhoto={deletePhoto} photos={photos} takePhoto={takePhoto} replacePhoto={replacePhoto}/>
                    </Route>
                    <Route exact path="/">
                        <Redirect to="/tab2" />
                    </Route>
